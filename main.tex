...
\author{
    \IEEEauthorblockN{Gautam Singh, Sachinkumar Omprakash Dubey and G.V.V. Sharma} 
...
\cite{laoudiasSurveyEnablingTechnologies2018}. Reliable PLAN technology can
reduce road accidents, congestion, energy and time consumption. However, many
existing PLAN technologies are expensive, complex, cater to industrial use cases
and require hardware that might be scarcely available to consumers \cite{}. 
